...
namespace HackToon.Services.Interface
{
    public interface IApiService
    {
        ...
        Task<string> GetMarvelCreators(int? limit, int? offset, string ts, string hash);
        ...
        Task<CreatorsResponse> GetAllCreators();
        Task<CreatorsPagedResponse> GetPagedCreators(int pageNumber, int pageSize);
